      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-2">
          {caseStudies.map((study, index) => (
            <Reveal key={study.id} delay={index * 0.06} className="flex">
              <article className="flex w-full flex-col rounded-card border border-line bg-surface p-7 shadow-card transition-shadow duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-lift sm:p-8">
                ...
                <h3 className="mt-3 text-xl font-semibold leading-snug tracking-[-0.02em] text-ink">
                  {study.title}
                </h3>
        ...
        <Reveal delay={0.1}>
          <p className="mt-8">
            ...
            >
              Nine engagements are documented in full
              <ArrowRightIcon
                size={15}
                weight="bold"
                aria-hidden="true"
