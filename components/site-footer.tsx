...
export function SiteFooter() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-line bg-surface px-4 pt-16 sm:px-6">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div aria-hidden="true" className="pointer-events-none select-none pt-4">
          ...
          */}
          <span className="block -mb-[0.16em] w-full whitespace-nowrap text-center text-[clamp(3rem,13vw,11.5rem)] font-semibold leading-[0.82] tracking-[-0.055em] text-accent/12">
            {company.wordmark}
          </span>
        </div>
      </div>
